/*
 * imx485_mode_tbls.h - imx485 sensor mode tables
 *
...
#ifndef __IMX485_TABLES__
#define __IMX485_TABLES__

/**
 * Image sensor registers as described in the IMX485 register map
 */
 ...
 */
#define IMX485_TABLE_WAIT_MS 0
#define IMX485_TABLE_END     1
#define IMX485_WAIT_MS       10

#define IMX485_DEFAULT_WIDTH            3864
#define IMX485_DEFAULT_HEIGHT           2180
#define IMX485_CROP_1920x1080_WIDTH     1920
#define IMX485_CROP_1920x1080_HEIGHT    1080
#define IMX485_MODE_BINNING_H2V2_WIDTH  1932
#define IMX485_MODE_BINNING_H2V2_HEIGHT 1090
 ...
 */
#define IMX485_MIN_FRAME_LENGTH_DELTA 70

#define IMX485_TO_LOW_BYTE(x) (x & 0xFF)
#define IMX485_TO_MID_BYTE(x) (x >> 8)

typedef struct reg_8 imx485_reg;

/**
 * Tables for the write table function
 */

static const imx485_reg imx485_start[] = {

    {STANDBY,              0x00},
    {IMX485_TABLE_WAIT_MS, 30},
    {XMSTA,                0x00},

    {IMX485_TABLE_WAIT_MS, IMX485_WAIT_MS},
    {IMX485_TABLE_END,     0x00}
};

static const imx485_reg imx485_stop[] = {
...
static const imx485_reg imx485_10bit_mode[] = {
...
static const imx485_reg imx485_12bit_mode[] = {
...
static const imx485_reg imx485_1782_mbps[] = {
    ...
    {IMX485_TABLE_WAIT_MS, IMX485_WAIT_MS},
    {IMX485_TABLE_END,     0x0000}
};

static const imx485_reg imx485_1440_mbps[] = {
...
static const imx485_reg imx485_init_settings[] = {
...
static const imx485_reg mode_3864x2180[] = {
...
static const imx485_reg mode_h2v2_binning[] = {
...
static const imx485_reg mode_crop_1920x1080[] = {
    ...
    {PIX_HST_HIGH,          IMX485_TO_MID_BYTE(972)},
    {PIX_HST_LOW,           IMX485_TO_LOW_BYTE(972)},
    {PIX_HWIDTH_HIGH,       IMX485_TO_MID_BYTE(IMX485_CROP_1920x1080_WIDTH)},
    {PIX_HWIDTH_LOW,        IMX485_TO_LOW_BYTE(IMX485_CROP_1920x1080_WIDTH)},

    {PIX_VST_HIGH,          IMX485_TO_MID_BYTE(548)},
    {PIX_VST_LOW,           IMX485_TO_LOW_BYTE(548)},
    {PIX_VWIDTH_HIGH,       IMX485_TO_MID_BYTE(IMX485_CROP_1920x1080_HEIGHT)},
    {PIX_VWIDTH_LOW,        IMX485_TO_LOW_BYTE(IMX485_CROP_1920x1080_HEIGHT)},

    {IMX485_TABLE_WAIT_MS,  IMX485_WAIT_MS},
    {IMX485_TABLE_END,      0x0000}
};

static const imx485_reg mode_enable_pattern_generator[] = {
...
static const imx485_reg mode_disable_pattern_generator[] = {
...
enum {
    ...
    IMX485_EN_PATTERN_GEN,
    IMX485_DIS_PATTERN_GEN,

    IMX485_INIT_SETTINGS,
    IMX485_MODE_START_STREAM,
    IMX485_MODE_STOP_STREAM,
};
...
static const imx485_reg *data_rate_table[] = {
    [IMX485_1782_MBPS] = imx485_1782_mbps,
    [IMX485_1440_MBPS] = imx485_1440_mbps,
};
...
static const imx485_reg *mode_table[] = {
    ...
    [IMX485_10BIT_MODE]          = imx485_10bit_mode,
    [IMX485_12BIT_MODE]          = imx485_12bit_mode,

    [IMX485_INIT_SETTINGS]       = imx485_init_settings,

    [IMX485_MODE_START_STREAM]   = imx485_start,
    [IMX485_MODE_STOP_STREAM]    = imx485_stop,
};
...
static const int imx485_72fps[] = {
    72,
};
static const int imx485_90fps[] = {
    90,
};
static const int imx485_142fps[] = {
    142,
};
...
static const struct camera_common_frmfmt imx485_frmfmt[] = {
    {
        ...
        .num_framerates = 1,
        .hdr_en = false,
        .mode = IMX485_MODE_3864x2180
    },
    {
        .size = {IMX485_CROP_1920x1080_WIDTH, IMX485_CROP_1920x1080_HEIGHT},
        .framerates = imx485_142fps,
        .num_framerates = 1,
        .hdr_en = false,
